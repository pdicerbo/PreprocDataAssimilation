% readRUN_doEOFs_GRID(gridFile,outDir)
% read RUN BFM on grid43 and prepare EOFs on grid 72
...
profiliREG = profiliREG(:,1:ii,:); 
    ...
    switch caseNREG
        case   1, eofFile=[outDir 'MED/eof.',num2str(NREGIONI),'.',num2str(mm,'%02d'),'.nc'];
        case   2, eofFile=[outDir 'ESO/eof.',num2str(NREGIONI),'.',num2str(mm,'%02d'),'.nc'];
        case   9, eofFile=[outDir 'SUB/eof.',num2str(NREGIONI),'.',num2str(mm,'%02d'),'.nc'];
        case 100, eofFile=[outDir 'ALL/eof.',num2str(NREGIONI),'.',num2str(mm,'%02d'),'.nc'];
        otherwise
